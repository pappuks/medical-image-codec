...
% Times New Roman-equivalent: newtxtext (text) + newtxmath (math)
% Both are in TeX Live 2023/2025 and fully supported on arXiv.
% amssymb must be loaded BEFORE newtxmath to avoid the \Bbbk conflict
% (see arXiv TeX Live FAQ: "newtxmath.sty and amssymb.sty conflict").
\usepackage{newtxtext}
\usepackage{amssymb}
\usepackage{amsmath}
\usepackage{amsthm}
\let\openbox\relax   % avoid clash between amsthm and newtxmath
\usepackage{newtxmath}
\usepackage[letterpaper, top=0.75in, bottom=1in, left=0.65in, right=0.65in, columnsep=0.2in]{geometry}
\usepackage{titlesec}
\usepackage{graphicx}
\usepackage{booktabs}
\usepackage{array}
...
%   \section    -> bold small-caps (e.g. "I. Introduction")
