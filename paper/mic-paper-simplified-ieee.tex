...
through these standards: none of them was designed natively for medical imaging.
Their prediction and entropy stages originated in photographic and
general-purpose imaging, where pixels are typically 8 bits, and were later
applied to the 10--16-bit data that medical scanners produce. MIC takes the
opposite approach and is built from the ground up for medical images.
...
deep. Starting from these properties, we surveyed entropy-coding and
